...
public interface P4GrammarListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link P4GrammarParser#comment}.
	 * @param ctx the parse tree
	 */
	void enterComment(P4GrammarParser.CommentContext ctx);
	/**
	 * Exit a parse tree produced by {@link P4GrammarParser#comment}.
	 * @param ctx the parse tree
	 */
	void exitComment(P4GrammarParser.CommentContext ctx);
}
